...
L["Loot everything with a price greater or equal to this value"] = "Pega todos os itens com preço maior ou igual a esse valor"
--[[Translation missing --]]
L["Loot quest itens"] = "Loot quest itens"
--[[Translation missing --]]
...
--[[Translation missing --]]
L["Loot everything with a price greater or equal to this value"] = "Pega todos os itens com preço maior ou igual a esse valor"
L["Loot quest itens"] = "Recolectar objetos de misión"
...
L["Loot quest itens"] = "Собирать квестовые предметы"
